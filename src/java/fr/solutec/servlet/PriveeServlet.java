...
import fr.solutec.dao.NoteRapideDao;
...
public class PriveeServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (u != null) {
            try {
                List<NoteRapide> notes = NoteRapideDao.getAllNoteByUser(u);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        NoteRapide note = new NoteRapide(0, information, null, u);
        try {
            NoteRapideDao.insertNote(note);
            response.sendRedirect("privee");
        } catch (Exception e) {
            PrintWriter out = response.getWriter();
            out.println(e.getMessage());
        }
