<%-- 
    Document   : menu
    Created on : 5 mai 2021, 16:08:55
    Author     : joelg
--%>
    ...
    <body>
        <div>
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand">DEV-2-2021</a>
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav nav-fill w-100">
                        ...
                        <a class="nav-item nav-link" href="privee">Privée</a>
                        <a class="nav-item nav-link" href="publique">Public</a>
